...
CONST attr1 as uByte = 15
CONST attr2 as uByte = 23
CONST attr3 as uByte = 31
CONST attr4 as uByte = 39
CONST attr5 as uByte = 47
CONST attr6 as uByte = 49
...
poke (@CURSOR + 32),attr1: poke (@CURSOR + 33),attr1: poke (@CURSOR + 34),attr1: poke (@CURSOR + 35),attr1
...
MAPEA:
			...
			for d = yBoard to yBoard + (yAlto*2)-2 step 2
				...
				for f = xBoard to xBoard + (xAncho*2)-2 step 2
					...
					if a=41 then a = 10: poke (@CURSOR + 32),attr1: poke (@CURSOR + 33),attr1: poke (@CURSOR + 34),attr1: poke (@CURSOR + 35),attr1:  nPlayers=1: xProta1=f: yProta1=d
					if a=42 then a = 10: poke (@CURSOR + 32),attr2: poke (@CURSOR + 33),attr2: poke (@CURSOR + 34),attr2: poke (@CURSOR + 35),attr2:  nPlayers=2: xProta2=f: yProta2=d
					if a=43 then a = 10: poke (@CURSOR + 32),attr3: poke (@CURSOR + 33),attr3: poke (@CURSOR + 34),attr3: poke (@CURSOR + 35),attr3:  nPlayers=3: xProta3=f: yProta3=d
					if a=44 then a = 10: poke (@CURSOR + 32),attr4: poke (@CURSOR + 33),attr4: poke (@CURSOR + 34),attr4: poke (@CURSOR + 35),attr4:  nPlayers=4: xProta4=f: yProta4=d
					if a=45 then a = 10: poke (@CURSOR + 32),attr5: poke (@CURSOR + 33),attr5: poke (@CURSOR + 34),attr5: poke (@CURSOR + 35),attr5:  nPlayers=5: xProta5=f: yProta5=d
					if a=46 then a = 10: poke (@CURSOR + 32),attr6: poke (@CURSOR + 33),attr6: poke (@CURSOR + 34),attr6: poke (@CURSOR + 35),attr6:  nPlayers=6: xProta6=f: yProta6=d
